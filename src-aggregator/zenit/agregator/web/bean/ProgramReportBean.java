...
public class ProgramReportBean implements Serializable{
	...
	private transient ProgramSubjectsAdapter programSubjectsAdapter;
	private transient BasicProgramGNAdapter basicProgramGNAAdapter;
	...
	public void initialize(HttpSession session) {
		...
		basicProgramGNAAdapter = ControllerListener.getEdgeController(session).getBasicProgramGNAAdapter();
		programSubjectsAdapter = ControllerListener.getEdgeController(session).getProgramSubjectsAdapter(); 
		initialized = true;
	}
